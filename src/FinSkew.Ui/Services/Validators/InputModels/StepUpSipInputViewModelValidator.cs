...
public class StepUpSipInputViewModelValidator : AbstractValidator<StepUpSipInputViewModel>
{
    public StepUpSipInputViewModelValidator()
    {
        ...
        RuleFor(x => x.StepUpPercentage)
            .InclusiveBetween(0, 50)
            .WithMessage("Step-up percentage must be between 0 and 50.");
